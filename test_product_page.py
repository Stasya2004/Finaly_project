...
#        product_page = ProductPage(browser, links) # Страница продукта
...
#        
#    def test_guest_can_go_to_login_page_from_product_page(self, browser):                                                                # Проверить !!!
#        link = "http://selenium1py.pythonanywhere.com/en-gb/catalogue/the-city-and-the-stars_95/"
#        page = ProductPage(browser, link)
#        page.open()
...
#    def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):                                                  # Проверить после main !!!
